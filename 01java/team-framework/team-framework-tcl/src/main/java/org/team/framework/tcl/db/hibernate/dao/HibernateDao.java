package org.team.framework.tcl.db.hibernate.dao;
...
public interface HibernateDao<T extends EntityObject, ID extends Serializable>{
   ...
   */
  T execute(HibernateCallback<T> action) throws DataAccessException;
   ...
   */
  T get(Class<T> entityClass, ID id) throws DataAccessException;
   ...
   */
  T get(Class<T> entityClass, ID id, LockMode lockMode) throws DataAccessException;
   ...
   */
  T load(Class<T> entityClass, ID id) throws DataAccessException;
   ...
   * @see org.hibernate.Session#load(Class, Serializable)
   */
  T load(Class<T> entityClass, ID id, LockMode lockMode) throws DataAccessException;
   ...
   */
  void load(T entity, ID id) throws DataAccessException;
   ...
   */
  void refresh(T entity, LockMode lockMode) throws DataAccessException;
   ...
   */
  void initialize(T proxy) throws DataAccessException;
   ...
   */
  void lock(T entity, LockMode lockMode) throws DataAccessException;
   ...
   */
  void lock(String entityName, T entity, LockMode lockMode) throws DataAccessException;
   ...
   * @see org.hibernate.Session#update(Object)
   */
  void update(T entity, LockMode lockMode) throws DataAccessException;
   ...
   */
  void replicate(T entity, ReplicationMode replicationMode) throws DataAccessException;
   ...
   */
  void replicate(String entityName, T entity, ReplicationMode replicationMode) throws DataAccessException;
   ...
   * @see org.hibernate.Session#delete(Object)
   */
  void delete(T entity, LockMode lockMode) throws DataAccessException;
   ...
   * @see org.hibernate.Session#delete(Object)
   */
  void delete(String entityName, T entity) throws DataAccessException;
   ...
   * @see org.hibernate.Session#delete(Object)
   */
  void delete(String entityName, T entity, LockMode lockMode) throws DataAccessException;
   ...
   */
  List<T> find(String queryString, Object... values) throws DataAccessException;
   ...
   */
  List<T> findByNamedParam(String queryString, String paramName, Object value) throws DataAccessException;
   ...
   * @see org.hibernate.Session#getNamedQuery(String)
   */
  List<T> findByNamedParam(String queryString, String[] paramNames, Object[] values) throws DataAccessException;
   ...
   * @see org.hibernate.Session#createQuery
   */
  List<T> findByValueBean(String queryString, Object valueBean) throws DataAccessException;
   ...
   * @see org.hibernate.Session#getNamedQuery(String)
   */
  List<T> findByNamedQuery(String queryName, Object... values) throws DataAccessException;
   ...
   */
  Iterator<T> iterate(String queryString, Object... values) throws DataAccessException;
   ...
   */
  void closeIterator(Iterator<T> it) throws DataAccessException;
  ...
  /**
   * 
   * @param queryString queryString an page query expressed in Hibernate's query language
   * @param page pager class
   * @param params params the values of the parameters
   */
  void findPageByHql(String queryString,Page page,Object... params);
}
