...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "黑暗", Source = AppearanceManager.DarkThemeSource });
            this.themes.Add(new Link { DisplayName = "明亮", Source = AppearanceManager.LightThemeSource });

            // add additional themes
            //this.themes.Add(new Link { DisplayName = "Bing图片", Source = new Uri("/ModernUIDemo;component/Assets/ModernUI.BingImage.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "Hello Kitty", Source = new Uri("/LL.Framework.Dcl;component/Views/Themes/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "心", Source = new Uri("/LL.Framework.Dcl;component/Views/Themes/ModernUI.Love.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "雪花", Source = new Uri("/LL.Framework.Dcl;component/Views/Themes/ModernUI.Snowflakes.xaml", UriKind.Relative) });
